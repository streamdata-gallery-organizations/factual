...
x-complete: 0
info:
  title: Factual Post Table Name Factual Flag
...
paths:
  ...
  /t/{table_name}/{factual_id}:
    get:
      summary: Get Table Name Factual
      description: Get table name factual.
      operationId: getTTableNameFactual
      x-api-path-slug: ttable-namefactual-id-get
      parameters:
      - in: path
        name: factual_id
      - in: path
  ...
  /t/{table_name}/{factual_id}/flag:
    post:
      summary: Post Table Name Factual Flag
      description: Post table name factual flag.
      operationId: postTTableNameFactualFlag
      x-api-path-slug: ttable-namefactual-idflag-post
      parameters:
      - in: path
        name: factual_id
      - in: path
